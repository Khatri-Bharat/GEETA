...
public class Graph implements Cloneable{
	...
	public Edge addEdge(String label, Node head, Node dep, Integer headLoc, Integer depLoc) {
		return this.addEdge(new Edge(label, head, dep, headLoc, depLoc));
	}
	...
	/** TODO As of now, the 'edgeMarkerMap' is not cloned.
